...
<?php get_header();?>
            ...
            <div class="services__items">
                <div class="services__item">
                    <div class="services__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/services/serv1.png" alt="Branding">
                    </div>
                ...
                <div class="services__item">
                    <div class="services__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/services/serv2.png" alt="Design">
                    </div>
                ...
                <div class="services__item">
                    <div class="services__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/services/serv3.png" alt="Development">
                    </div>
                ...
                <div class="services__item">
                    <div class="services__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/services/serv4.png" alt="ROCKET SCIENCE">
                    </div>
    ...
    <section class="team" id="team">
        <div class="container">
            ...
            <div>
                <div class="wprapper__teamSlider">
                    <div class="team__items" id="teamSlider">
                        <div>
                            <div class="team__item">
                                <div class="team__imgblk">
                                    <img src="<?php echo (get_template_directory_uri());?>/assets/img/team/team1.jpg" alt="photo">
                                </div>    
                                    ...
                                    <div class="team__item__icons">
                                        <div class="team__item__icon"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/icons/Fb icon.png" alt="Fb"></div>
                                        <div class="team__item__icon"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/icons/Twitter icon.png " alt="Twitter"></div>
                                        <div class="team__item__icon"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/icons/LinkedIn icon.png" alt="LinkedIn"></div>
                                        <div class="team__item__icon"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/icons/Mail icon.png" alt="Mail"></div>
                                    </div>
                            </div>
                        </div>
                        <div> 
                            <div class="team__item">
                                <div class="team__imgblk">
                                    <img src="<?php echo (get_template_directory_uri());?>/assets/img/team/team2.jpg" alt="photo">
                                </div>    
                                    ...
                                    <div class="team__item__icons2">
                                        <div class="team__item__icon2"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/icons/Twitter icon.png " alt="Twitter"></div>
                                        <div class="team__item__icon2"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/icons/LinkedIn icon.png" alt="LinkedIn"></div>
                                        <div class="team__item__icon2"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/icons/Mail icon.png" alt="Mail"></div>
                                    </div>
                            </div>
                        </div>
                        <div>
                            <div class="team__item">
                                <div class="team__imgblk">
                                    <img src="<?php echo (get_template_directory_uri());?>/assets/img/team/team3.jpg" alt="photo">
                                </div>    
                        ...
                        <div>
                            <div class="team__item">
                                <div class="team__imgblk">
                                    <img src="<?php echo (get_template_directory_uri());?>/assets/img/team/team4.jpg" alt="photo">
                                </div>    
                                    ...
                                    <div class="team__item__icons2">
                                        <div class="team__item__icon2"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/icons/Fb icon.png" alt="Fb"></div>
                                        <div class="team__item__icon2"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/icons/Twitter icon.png " alt="Twitter"></div>
                                        <div class="team__item__icon2"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/icons/Mail icon.png" alt="Mail"></div>
                                    </div>
                            </div>
            ...
            <div class="skills__items">
                <div class="skills__item">
                    <div class="skills__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/skills/1.png" alt="90%">
                    </div>
                    <div class="skills__item__title">Web Design</div>
                </div>
                <div class="skills__item">
                    <div class="skills__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/skills/2.png" alt="75%">
                    </div>
                    <div class="skills__item__title">HTML / CSS</div>
                </div>
                <div class="skills__item">
                    <div class="skills__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/skills/3.png" alt="70%">
                    </div>
                    <div class="skills__item__title">GRAPHIC DESIGN</div>
                </div>
                <div class="skills__item">
                    <div class="skills__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/skills/4.png" alt="80%">
                    </div>
           ...
           <div class="portfolio__items">
               <div class="portfolio__item">
                    <div class="portfolio__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/portfolio/portfolio1.png" alt="">   
                    </div>
                    <div class="portfolio__imgblk__title">Isometric Perspective Mock-Up</div>
               </div>
               <div class="portfolio__item">
                    <div class="portfolio__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/portfolio/portfolio2.png" alt=""> 
                    </div>
                    <div class="portfolio__imgblk__title">Time Zone App UI</div>
               </div>
               <div class="portfolio__item">
                    <div class="portfolio__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/portfolio/portfolio3.png" alt="">
                    </div>
                    <div class="portfolio__imgblk__title">Viro Media Players UI</div>
               </div>
               <div class="portfolio__item">
                    <div class="portfolio__imgblk">
                        <img src="<?php echo (get_template_directory_uri());?>/assets/img/portfolio/portfolio4.png" alt="">
                    </div>
    ...
    <section class="testimonials" id="testimonials">
        <div class="container">
            ...
            <div>
                <div class="wrapper__testimonialsSlider">
                    <div class="testimonials__items" id="testimonialsSlider">
                        <div>
                            <div class="testimonials__item">
                                <div class="testimonials__photo"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/team1.jpg" alt="Chanel Iman"></div>
                        ...
                        <div>
                            <div class=" testimonials__item">
                                <div class="testimonials__photo"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/team2.jpg" alt="Chanel Iman"></div>
                                <div class="testimonials__quote">
                        ...
                        <div>
                            <div class="testimonials__item">
                                <div class="testimonials__photo"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/team3.jpg" alt="Chanel Iman"></div>
                                <div class="testimonials__quote">
                                    <p>“Vivamus luctus urna sed urna ultricies ac tempor dui sagittis. In condimentum facilisis porta.”</p>
                                </div>
                                <div class="testimonials__description">
                        ...
                        <div>
                            <div class="testimonials__item">
                                <div class="testimonials__photo"><img src="<?php echo (get_template_directory_uri());?>/assets/img/team/team4.jpg" alt="Chanel Iman"></div>
                                <div class="testimonials__quote">
